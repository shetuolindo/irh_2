      ...
      <tbody>
         @forelse($resources as $resource)
            <tr data-row-id="{{ $resource->id }}">
               ...
               <td><a href="{{ route('theme.singleresource',$resource->id) }}" target="_blank">{!! str_limit($resource->title, 12) !!}</a></td>
               <td class="td_center">
               ...
               <td>
                  <a href="{{ route('admin.create.resource.edit', $resource->id) }}" class="link"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
