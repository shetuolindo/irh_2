				...
				<div class="col-md-9 float-left upload_right resid" {{ isset($resource) ? ('data-res-id=' . $resource->id . '') : '' }}>
					<div class="tabFormNxtMain">
						<div class="tabFormNxt" data-li-atr="link0" style="display: block;">
							<form name="link0" data-form-id="link0" method="post" action="{{ route('admin.create.resource.save') }}">
								@csrf
								...
								<div class="uploadResource_right">
									...
									<div class="form-row">
										<div class="form-group marginBotNone col-md-12">
											<label for="inputCity">Select file(s) to upload</label>
										</div>
										...
										<div class="form-group col-md-6">
											<div class="photoUpload" id="preview_attachment_div">
												<div class="editProImg">
													...
													<div class="box">
														<input type="file" name="preview_attachment" id="preview_attachment" class="inputfile inputfile-2" data-multiple-caption="{count} files selected">
						...
						<div class="tabFormNxt" data-li-atr="link1" style="display: none;">
							<form name="link1" data-form-id="link1" method="post" action="{{ route('admin.create.resource.save') }}">
								@csrf
										...
										<div class="form-row">
											<div class="col">
												<div class="border_box">
													...
													<!-- <div class="input-group input-group-sm mb-2 customeDropdown">
													...
													<!-- <select class="custom-select" multiple name="age_group[]">
								                        @foreach($filters as $filter)
								                        @if($filter->tag_group == 'Age Group')
								                        <option value="{{ $filter->id }}" <?php 
								                        	//if(isset($resource_tag) && in_array($filter->id, $resource_tag)){
											...
											<div class="col">
												<div class="border_box">
													<h3>Pick resource type. (Select one) ZZ
													</h3>
													...
													<!-- <select class="custom-select" multiple name="resource_type[]">
								                        @foreach($filters as $filter)
								                        @if($filter->tag_group == 'Resource Type')
								                        <option value="{{ $filter->id }}" <?php 
								                        	//if(isset($resource_tag) && in_array($filter->id, $resource_tag)){
						...
						<div class="tabFormNxt" data-li-atr="link2" style="display: none;">
							<form name="link2" data-form-id="link2" method="post" action="{{ route('admin.create.resource.save') }}">
								@csrf
						...
						<div class="tabFormNxt" data-li-atr="link3" style="display: none;">
							<form name="link3" data-form-id="link3" method="post" action="{{ route('admin.create.resource.save') }}">
								@csrf
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.15/js/bootstrap-multiselect.min.js"></script>
   <script>
      	...
      	$(".litab").click(function(){
      		if ($('.resid').attr('data-res-id') != undefined) {
		...
		$('#catagori1').multiselect({
		includeSelectAllOption: true
		});

		$('#catagori2').multiselect({
		includeSelectAllOption: true
		});
</script>
