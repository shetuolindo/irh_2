            ...
            <table class="table" id="resources-table">
              ...
              <tbody>
                ...
                <tr data-row-id="{{ $tag->id }}">
                  <td>{{ $tag->tag_group }}</td>
                  <td>{{ $tag->name }}</td>
                  <td><a href="javascript:void(0)" class="link tag_link"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> </td>
                </tr>
                @endforeach
              </tbody>
            </table>
            ...
            <table class="table" id="resources-table">
              ...
              <tbody>
                ...
                <tr data-row-id="{{ $resourceCategory->id }}">
                  ...
                  <td><a href="javascript:void(0)" class="link cat_link"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> </td>
                </tr>
                @endforeach
              </tbody>
            </table>
