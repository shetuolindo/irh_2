<meta charset="utf-8">
<title>IRH @yield('page_title') </title>
<!--
...
<link href="{{ asset('irh_assets/vendor/bootstrap/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
<!-- Styles -->
...
<link href="{{ asset('irh_assets/css/component.css') }}" rel="stylesheet">
